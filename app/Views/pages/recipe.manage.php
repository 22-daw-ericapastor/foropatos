            ...
            <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="table-wrapper">
                            ...
                            <table id="recipes-table"
                                   class="table hover order-column compact table-responsive mt-4"></table>
                        </div>
                    </div>
                </div>
                ...
                <div class="container" id="uptd_rcp-container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-11">
                            <form id="add_rcp-form" method="post" action="?updt_rcp" enctype="multipart/form-data">
                                <!-- Title input-->
                                ...
                                <div class="d-flex flex-row w-100 justify-content-between">
                                    <!-- Close Button-->
                                    <button type="button" class="btn btn-danger close-panel">Cancelar</button>
                                    <!-- Submit Button-->
                                    <button type="submit" class="btn btn-primary" id="signin_btn" name="updtrcp">
                                        Guardar
                                    </button>
                                </div>
                            </form>
